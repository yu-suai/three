...
// 传送带路径（每个点包含位置和旋转）
const conveyorPath = [
  { position: [-20.12, 1.80, -7.63], rotation: [0, Math.PI / 3, 0], duration: 14 }, // 第一段结束

  { position: [-20.45, 1.45, -7.63], rotation: [0, 0, 0], duration: 3 }, // 第二段凋落起点
  { position: [-20.45, 1.45, -10.63], rotation: [0, 0, 0], duration: 3 }, // 第二段凋落结束

  { position: [-23.75, 2.04, -10.63], rotation: [0, 0, -Math.PI / 4], duration: 4 }, // 第三段起点
  { position: [-23.75, 1.85, -7.03], rotation: [0, 0, 0], duration: 2 }, // 第三段结束

  { position: [-23.75, 2.20, -6.30], rotation: [0, 0, 0], duration: 1 }, // 第四段起点
  { position: [-23.75, 1.80, -5.69], rotation: [0, 0, 0], duration: 2 }, // 第四段结束

  { position: [-25.89, 1.80, -5.69], rotation: [0, 0, 0], duration: 2 }, // 第五段起点
  { position: [-25.89, 1.50, -5.69], rotation: [0, 0, 0], duration: 2 }, // 第五段结束

  { position: [-27.50, 1.50, -5.69], rotation: [0, 0, 0], duration: 2 }, // 第六段起点
  // { position: [3.74, 4.05, -8.51], rotation: [-Math.PI / 2, Math.PI, 0], duration: 1 }, // 终点
];

function set_packaging_conveyor_belt(scene, sourceModelName, modelsToRemove = []) {
...
function cancel_packaging_conveyor_belt(scene) {
  if (scene.userData.conveyorBeltInterval) {
...
export { set_packaging_conveyor_belt, cancel_packaging_conveyor_belt };
